...
const ONBOARDING_STEPS: StepConfig[] = [
  {
    ...
    description: 'Take photos of your artwork and share them with your class',
    iconName: 'camera.fill',
    navigationTarget: '/(tabs)/camera',
  },
  {
    feature: 'juni',
    title: 'Ask Juni About Your Art',
    description: 'Get AI-powered feedback and tips to improve your artistic skills',
    iconName: 'brain',
  ...
  },
  {
    ...
    description: 'Give and get feedback from classmates in a supportive environment',
    iconName: 'house.fill',
